            ...
            >
                ...
                <div>
                    ...
                    <div class="relative py-10 px-14 flex-auto bg-black rounded-tl-full">
                        <h2 class="text-white inline-block" style="font-size:32px;font-weight:800;">RESET PASSWORD</h2>
                        ...
                        <div class="mt-6">
                            <p class="text-white font-semibold">Forgot your password? No problem. Just let us know your email address and we will email you a password reset link that will allow you to choose a new one.</p>
                        </div>
                        <form method="POST" action="/forgot-password" class="inline-block w-full">
                            @csrf
                            <div class="mt-6">
