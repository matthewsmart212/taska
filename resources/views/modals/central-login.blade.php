...
<div class="hidden overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none justify-center items-center" id="central-login">
            ...
            <form method="POST">
                ...
                <div>
                    ...
                    <div class="relative py-10 px-14 flex-auto bg-black rounded-tl-full">
                        ...
                        <div class="cursor-pointer inline-block text-gray-200" type="button" onclick="toggleModal('central-login')" style="text-align: right; float: right; margin-top: -3px; font-size: 32px; padding: 0 10px; }">
                            x
                        </div>
