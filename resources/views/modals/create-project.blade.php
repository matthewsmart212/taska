...
<div class="hidden overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none justify-center items-center" id="modal-id">
    <div class="relative w-auto my-6 mx-auto max-w-3xl">
        ...
        <div class="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
            ...
            @csrf
                <input type="text" name="background_image" id="background_image" hidden value="1"/>
                <!--body-->
                <div class="relative p-6 flex-auto">
                    <div class="mb-3">
                        <label class="">Title:
                            <input type="text" name="title" class="w-full rounded-lg mt-2 border-gray-300" value="" required/>
                        </label>
                    </div>
                    ...
                    <div class="mt-3 grid grid-cols-3 gap-5">
                        @for($i=1;$i<10;$i++)
                            <div class="relative">
                                <i class="far fa-check-circle absolute bottom-2 right-2 text-green-400 @if($i > 1) hidden @endif" ></i>
